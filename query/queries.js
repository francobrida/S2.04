...
db.restaurants.find({"location.coordinates": {
                        $near: {
                          $geometry:{
                            ...
                            coordinates: [-74, 40.7]},
                          $maxDistance: 5000}}}, 
                    {restaurant_id:1,name:1,"address.street":1,
                     "address.zipcode":1,"location.coordinates":1, _id:0})
...
db.restaurants.find({"location.coordinates": {$type: "double"}}, 
                    {name:1, restaurant_id:1, "location.coordinates":1, _id:0})
...
db.restaurants.find({"grades.score": {$mod: [7,0]}}, 
                    {restaurant_id:1, name:1, "grades.grade":1, _id:0})

// 31. Trobar name, borough, longitud, latitud i cuisine per noms que contenen 'mon'.
db.restaurants.find({name: /mon/}, 
                    {name:1, borough:1, "location.coordinates.0":1, "location.coordinates.1":1, cuisine:1, _id:0})
...
db.restaurants.find({grades: {
                    ...
                    {restaurant_id:1, name:1, "grades.grade":1, "grades.score":1,_id:0})
